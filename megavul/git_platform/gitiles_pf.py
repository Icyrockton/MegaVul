...
from megavul.git_platform.common import CommitInfo, DownloadedCommitInfo, trunc_commit_file_name, \
    try_decode_binary_data_and_write_to_file, RawCommitInfo
from megavul.util.logging_util import global_logger
from megavul.util.utils import gitiles_safe_get_bs4_request, gitiles_safe_get_request, check_file_exists_and_not_empty, \
