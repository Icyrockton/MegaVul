...
from megavul.git_platform.common import DownloadedCommitInfo, CveWithDownloadedCommitInfo, try_repo_name_merge, \
...
from megavul.pipeline.extract_commit_diff_util import traverse_all_commit, RepoType, traverse_single_commit, \
    get_file_type_using_linguist, ExtractCommitDiffRecorder, difflib_diff_func
from megavul.pipeline.json_save_location import cve_with_parsed_commit_json_path, cve_with_downloaded_commit_json_path, \
