...
from vul4c.git_platform.common import CveWithCommitInfo, CommitInfo, VulnerableFunction, NonVulnerableFunction
from vul4c.pipeline.json_save_location import cve_with_graph_abstract_commit_json_path, vul4c_json_path, \
    vul4c_simple_json_path
from vul4c.util.utils import load_from_marshmallow_dataclass_json_file, save_marshmallow_dataclass_to_json_file
...
def add_vul_func(dst: list[Vul4CFunction],simple_dst:list[Vul4CSimpleFunction], cve: CveWithCommitInfo, commit: CommitInfo, file_path: str,
                 vul_func: VulnerableFunction):
    dst.append(Vul4CFunction(
    ...
    simple_dst.append( Vul4CSimpleFunction(
...
def add_non_vul_func(dst: list,simple_dst:list[Vul4CSimpleFunction], cve: CveWithCommitInfo, commit: CommitInfo, file_path: str,
...
def generate_vul4c():
    """
        generate a flattened version of Vul4C for ease of use, and distribute this version dataset
    """
    ...
    final_result :list[Vul4CFunction] = []
    simple_final_result :list[Vul4CSimpleFunction] = []
    ...
    save_marshmallow_dataclass_to_json_file(Vul4CFunction, vul4c_json_path, final_result)
    save_marshmallow_dataclass_to_json_file(Vul4CSimpleFunction, vul4c_simple_json_path, final_result)
