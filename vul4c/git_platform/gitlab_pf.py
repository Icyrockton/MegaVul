...
from vul4c.git_platform.common import CommitInfo, trunc_commit_file_name, \
    try_decode_binary_data_and_write_to_file, RawCommitInfo
from vul4c.util.utils import get_bs4_parsed_html, get_request_in_json, check_file_exists_and_not_empty, \
    get_unix_time_from_git_date_gitlab
import bs4
import re
from vul4c.git_platform.git_platform_base import GitPlatformBase
from vul4c.util.utils import proxies
